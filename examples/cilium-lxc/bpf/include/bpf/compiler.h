...
# ifdef KLEE_VERIFICATION
   /* Compile-time guards become no-ops: __builtin_constant_p() returns 0 at -O0
    * for function arguments, causing these checks to fire spuriously. */
...
#ifndef barrier
# ifdef KLEE_VERIFICATION
#  define barrier()		/* no-op under KLEE: passthrough intrinsic unsupported */
# else
