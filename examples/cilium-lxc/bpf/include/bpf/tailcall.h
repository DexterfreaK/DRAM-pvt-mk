...
/* Tail calls are not supported under KLEE — treat as no-op stubs. */
static __always_inline __maybe_unused void
tail_call_static(const struct __ctx_buff *ctx __maybe_unused,
		 const void *map __maybe_unused, const __u32 slot __maybe_unused) {}
static __always_inline __maybe_unused void
tail_call_dynamic(struct __ctx_buff *ctx __maybe_unused,
